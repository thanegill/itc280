...
//EDIT THE FOLLOWING:
$fromAddress = "noreply@thanegill.com";  //replace example.com with the website's domain - leave set as 'noreply'
$toAddress = "me@thanegill.com";  //place your/your customer's email address here - ZEPHIR WILL ONLY EMAIL seattlecentral.edu ADDRESSES!
$website = "ITC280";  //place name of your customer's website here
...
if (!isset($_POST["recaptcha_response_field"])|| $error != "") {
	...
	<table border="1" style="border-collapse:collapse" align="center">
		...
		<tr>
			<td align="right">What Services Are You Interested In?:</td>
			<td>
				<input type="checkbox" name="Interested_In[]" value="New Website" /> New Website <br />
				<input type="checkbox" name="Interested_In[]" value="Website Redesign" /> Website Redesign <br />
