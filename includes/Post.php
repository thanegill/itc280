...
class Post {
	...
	function displayArticle() {
		...
		echo('<article>
		<h1><a href="/posts/?p=' . $this->link .'">' . $this->getFullTitle() . '</a></h1>
		' . Markdown($this->body). '
		<span class="date-comments">' . date('l\, F jS Y', strtotime($this->date)) . $timeSpentWord . ' - <a href="/posts/?p=' . $this->link . '#comments">' . sizeof($this->comments) . ' ' . $commentWord . '</a></span>
		</article>');
